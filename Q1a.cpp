...
#include <math.h>
#include <SDL2/SDL.h>
#include <omp.h>        // Make sure this header is included
...
void draw_circle(SDL_Renderer* renderer) {
    ...
    // Loop through all points sequentially
...
int main(int argc, char* argv[]) {
    ...
    // Create a window
    SDL_Window* window = SDL_CreateWindow("Circle with Serial Execution", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, 600, 600, SDL_WINDOW_SHOWN);
    if (!window) {
